...
public class ProductController {
    ...
    public void renewProduct() throws IOException {
        ...
        commonUtil.generateDirectories(formatToday);
        ...
        newC24CostcoProductsSet.forEach(c24CostcoProduct -> {
            ...
            // 새 상품 crawl
            try {
                crawlService.crawlProduct(c24CostcoProduct, formatToday);
        ...
        existingC24CostcoProductsMap.forEach((productCode, c24List) -> {
            ...
            if (!(isSameObjects && hasMustAttributes)) {
                ...
                // crawl product
                try {
                    c24CostcoProduct = crawlService.crawlProduct(productCode, formatToday);
                } catch (Exception e) {
                    crawlService.quit();
                    throw new RuntimeException(e);
                }
